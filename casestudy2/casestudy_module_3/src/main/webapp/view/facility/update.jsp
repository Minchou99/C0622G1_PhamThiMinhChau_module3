...
<div class="mx-5 px-5 pt-3">
    ...
    <p class="text-center mt-3"><a href="/home"><i class="fa-solid fa-house-chimney h5 mx-1"></i> Back to HOME</a></p>

    <p class="text-center">
        <a href="/facilities"><i class="fa-solid fa-backward"></i> Back to Facility list</a>
    </p>
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" method="post">
            <div class="form-group" hidden>
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="facilityId" value="${facility.id}" readonly>
            ...
            <c:forEach var="facilityType" items="${facilityTypeList}">
                <c:if test="${facility.facilityTypeId==facilityType.id}">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" value="${facility.facilityTypeId}" name="facility_type_id" hidden readonly>
                            <input type="text" class="form-control" value="${facilityType.name}"
                                   readonly>
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="number" id="maxPeople" class="form-control" name="max_people"
            ...
            <c:if test="${facility.facilityTypeId==1 or facility.facilityTypeId==2}">
                <div class="mt-3 form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="standardRoom" class="form-control" name="standard_room"
            ...
            <c:if test="${facility.facilityTypeId==1 or facility.facilityTypeId==2}">
                <div class="mt-3 form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="description" class="form-control" name="description_other_convenience"
            ...
            <c:if test="${facility.facilityTypeId==3}">
                <div class="mt-3 form-group" hidden>
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="description_other_convenience" value=" -">
                        <span class="input-group-text"><i class="fa-solid fa-book"></i></span>
                    </div>
                </div>
            </c:if>
            ...
            <c:if test="${facility.facilityTypeId==1}">
                <div class="mt-3 form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="poolArea" class="form-control" name="pool_area"
            ...
            <c:if test="${facility.facilityTypeId==2 or facility.facilityTypeId==3}">
                <div class="mt-3 form-group" hidden>
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="pool_area" value="0">
                        <span class="input-group-text"><i class="fa-solid fa-person-swimming"></i></span>
                    </div>
                </div>
            </c:if>
            ...
            <c:if test="${facility.facilityTypeId==1 or facility.facilityTypeId==2}">
                <div class="mt-3 form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="numberOfFloors" class="form-control" name="number_of_floor"
            ...
            <c:if test="${facility.facilityTypeId==3}">
                <div class="mt-3 form-group" hidden>
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="number_of_floor" value="0">
                        <span class="input-group-text"><i class="fa-solid fa-building"></i></span>
                    </div>
                </div>
            </c:if>
            ...
            <c:if test="${facility.facilityTypeId==3}">
                <div class="mt-3 form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="facilityFree" class="form-control" name="facility_free"

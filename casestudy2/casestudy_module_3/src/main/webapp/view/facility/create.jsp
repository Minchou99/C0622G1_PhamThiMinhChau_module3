...
<div class="mx-5 px-5 pt-3">
    ...
    <div class="d-flex justify-content-center">
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" action="/facilities?action=create"
              method="post">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="number" id="maxPeople" class="form-control"
                           placeholder="Input maximum number of people" name="max_people">
            ...
            <div class="mt-3 form-group" id="standardRoomForm">
                ...
                <div class="input-group">
                    <input type="text" id="standardRoom" class="form-control" name="standard_room" value=" -">
            ...
            <div class="mt-3 form-group" id="descriptionForm">
                ...
                <div class="input-group">
                    <input type="text" id="description" class="form-control" name="description_other_convenience" value=" -">
            ...
            <div class="mt-3 form-group" id="poolAreaForm">
                ...
                <div class="input-group">
                    <input type="text" id="poolArea" class="form-control" name="pool_area" value="0">
            ...
            <div class="mt-3 form-group" id="numberOfFloorsForm">
                ...
                <div class="input-group">
                    <input type="number" id="numberOfFloors" class="form-control" name="number_of_floor" value="0">
            ...
            <div class="mt-3 form-group" id="facilityFreeForm" style="display: none">
                ...
                <div class="input-group">
                    <input type="text" id="facilityFree" class="form-control" name="facility_free" value=" -">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <select id="rentType" class="form-control" name="rent_type_id">
